    ...
    <Screen style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        <Text style={styles.title}>
          <Text>Privacy Policy for Circuits°</Text>
        </Text>

        <Text style={[{ fontSize: 24, fontWeight: "bold" }, styles.h1]}>
          <Text>Privacy Policy</Text>
        </Text>

        <Text style={[styles.text, { marginBottom: 40 }]}>
          <Text>Last updated: November 13, 2023</Text>
        </Text>
        ...
        <Text style={styles.text}>
          ...
          <Text>Privacy Policy Generator</Text>
        ...
        <Text style={[{ fontSize: 20, fontWeight: "bold" }, styles.h2]}>
        ...
        <View>
          ...
          <Text style={styles.text}>
            ...
            <Text>
              refers to Circuits°, the software program provided by the Company.
            </Text>
          </Text>
          ...
          <Text style={styles.text}>
            ...
            <Text>refers to: Ontario, Canada</Text>
          </Text>
          <Text style={styles.text}>
            <Text style={{ fontWeight: "bold" }}>
              <Text>- Device </Text>
        ...
        <Text style={[{ fontSize: 18, fontWeight: "bold" }, styles.h3]}>
          <Text>Personal Data</Text>
        </Text>
        ...
        <Text style={{ ...styles.text, marginBottom: 30, marginTop: 40 }}>
          <Text>
        ...
        <View>
          ...
          <Text style={styles.text}>
            <Text style={{ fontWeight: "bold" }}>
              <Text>- With business partners: </Text>
            </Text>
            <Text>
        ...
        <View>
          <Text style={styles.text}>
            <Text>By email: circuit.timer@gmail.com</Text>
          </Text>
        </View>
